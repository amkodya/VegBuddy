...
<?php include("../models/header.php"); ?>
 ...
 <!-- RECIPES -->
  ...
  <h3>RECIPES</h3>
    <div id="siderec">           
      <a href="breakfast.php#recipe"><b>Breakfast</b></a><br>
        ...
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
              <img src="../images/jumbochickpeapancake.jpg" id="smallrecipepagepics">
      ...
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
          <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
            <img src="../images/blueberryoatmealwaffles.jpg" id="smallrecipepagepics">
    ...
    <div class="panel-heading" role="tab" id="headingThree">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <img src="../images/tofuomelets.jpg" id="smallrecipepagepics">
          Tofu Omelets
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading" role="tab" id="headingFour">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
          <img src="../images/bakedblueberrydonuts.jpg" id="smallrecipepagepics">
